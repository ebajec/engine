...
#define log_error(format, ...) _log_function(LOG_LEVEL_WARN, __FILE__, __LINE__, format, ##__VA_ARGS__)
#define log_warn(format, ...)  _log_function(LOG_LEVEL_ERROR, __FILE__, __LINE__, format, ##__VA_ARGS__)
#else 
