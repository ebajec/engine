...
ev2::Result gl_shader_create(ev2::Context *dev, ev2::Shader *p_shader, const char *path)
{
...
void gl_shader_destroy(ev2::Context *dev, void *usr)
{
	if (!usr) 
		return;
...
ev2::Result gl_shader_reload(ev2::Context *dev, void **usr, const char *path)
{
...
std::string get_gfx_pipeline_info(ev2::Context *dev, ev2::GraphicsPipeline *p_pipeline)
{
...
static void gl_gfx_pipeline_destroy(ev2::Context *dev, void* usr) 
{
...
static ev2::Result gl_gfx_pipeline_reload(ev2::Context *dev, void** usr, const char *path)
{
...
static void gl_compute_pipeline_destroy(ev2::Context *dev, void* usr) 
{
...
static ev2::Result gl_compute_pipeline_reload(ev2::Context *dev, void** usr, const char *path)
{
...
void unload_shader(Context *dev, ShaderID shader)
{
}
...
DescriptorLayoutID get_graphics_pipeline_layout(Context *dev, GraphicsPipelineID pipe)
{
...
DescriptorLayoutID get_compute_pipeline_layout(Context *dev, ComputePipelineID pipe)
{
	if (!pipe.id)
		return EV2_NULL_HANDLE(DescriptorLayout);
...
void destroy_descriptor_set(Context *dev, DescriptorSetID id)
{
...
RecorderID begin_commands(Context * dev, CommandMode mode)
{
...
{
	ev2::Context *dev = EV2_TYPE_PTR_CAST(Context, rec);
