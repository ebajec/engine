...
int GridFluidSim::init(ev2::GfxContext *ctx, uint32_t w, uint32_t h)
{
	...
	nvs_particles = ev2::load_compute_pipeline(ctx, "fluid://shader/nvs2_flip_advect.comp");
	nvs_advect = ev2::load_compute_pipeline(ctx, "fluid://shader/nvs2_advect_semi_lagrange.comp");
	nvs_diffuse = ev2::load_compute_pipeline(ctx, "fluid://shader/nvs2_diffuse.comp");
	nvs_divergence = ev2::load_compute_pipeline(ctx, "fluid://shader/nvs2_divergence.comp");
	nvs_project = ev2::load_compute_pipeline(ctx, "fluid://shader/nvs2_project.comp");
